...
> **Manual override.** The generated pairing was "Baloo 2 / Comic Neue" (kids /
> educational-games). EduLog is an institutional tool used by teachers, admins
> and parents, so that match was rejected in favour of the "Corporate Trust"
> pairing from `--domain typography` ("professional dashboard enterprise
> readable"). Lexend is designed for reading proficiency, which suits an
> education product without reading as a children's app.
